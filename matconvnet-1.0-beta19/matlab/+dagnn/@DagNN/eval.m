...
for l = obj.executionOrder
  time = tic ;
  res{l} = obj.vars(l).value;
%   if strcmp(obj.vars(l).name,'conv1_2')
%        res{1}=obj.vars(l).value;
%    elseif strcmp(obj.vars(l).name,'icp3_out')
%       res{2}=obj.vars(l).value;
%    elseif  strcmp(obj.vars(l).name,'icp4_out')
%        res{3}=obj.vars(l).value;
%    elseif strcmp(obj.vars(l).name,'icp5_out')
%        res{4}=obj.vars(l).value;
%    elseif strcmp(obj.vars(l).name,'icp6_out')
%        res{5}=obj.vars(l).value;
%    end
