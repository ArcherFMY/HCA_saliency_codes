function Superpixels = SLIC_Split(noFrameImg, spnumber, spPath, srcName)
...
%%
adjcMatrix8 = AdjcProcloop(idxImg);
...
Superpixels.sulabel = idxImg;
Superpixels.impfactor8 = adjcMatrix8;
Superpixels.pixelList = pixelList;
